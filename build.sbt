...
lazy val root = (project in file(".")).
  ...
  settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.kamon" %% "kamon-akka-http" % "2.5.0+9-7fd844a5" exclude("io.github.mofei100", "kamon-core_2.12") exclude("io.github.mofei100", "kamon-akka_2.12"),
      ...
      "io.kamon" %% "kamon-akka-grpc" % "2.5.0+9-7fd844a5",
